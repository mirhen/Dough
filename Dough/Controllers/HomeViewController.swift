...
class HomeViewController: UIViewController, ChartViewDelegate
{
        ...
        didSet
        {
            if expenses.count != 0
            {
                ...
                if expenseDictionary.count != 0
                {
                    if totalTimeUnit != 4
                    {
                        totalMoney = CalendarUnitHelper.convertToBalancePerWeek(totalTimeUnit, amountOfMoney: totalMoney)
    ...
    override func viewDidAppear(animated: Bool)
    {
        ...
        if spendingMoney == totalMoney - t
        {
            expenseDictionary["spending"] = spendingMoney
            
            spendingBalanceLabel.text = "$\(spendingMoney)"
    ...
    func setChart(dataPoints: [String], values: [Double])
    {
        ...
        print("setChart - dataPoints: \(dataPoints)")
        print("setChart -   values: \(values)")
